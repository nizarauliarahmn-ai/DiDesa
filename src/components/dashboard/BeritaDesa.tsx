...
const INITIAL_NEWS: NewsItem[] = [
  {
    ...
    comments: [
      ...
      { id: 'c2', name: 'Deddy Setiawan', text: 'Luar biasa Pemdes Ketupat. Pembangunan merata dan transparan.', date: '25 Okt 2023' }
    ],
    progressPhotos: [
  ...
  },
  {
    ...
    fullContent: `Untuk mengurangi ketergantungan para petani terhadap pupuk kimia yang harganya kian melambung tinggi, Dinas Pertanian Daerah bersama Gabungan Kelompok Tani (Gapoktan) Ketupat menyelenggarakan pelatihan pembuatan dan pemanfaatan pupuk kompos organik mandiri.\n\nPelatihan ini diselenggarakan selama dua hari berturut-turut dengan materi teori di kelas serta praktik langsung pembuatan pupuk di lapangan.\n\nBahan baku pembuatan kompos memanfaatkan potensi lokal yang melimpah ruah dan belum terkelola optimal, antara antara lain kotoran hewan ternak sapi/kambing, jerami sisa panen, serta dedaunan hijau dicampur dengan mikroorganisme pengurai EM4.\n\nKepala Desa mengharapkan melalui pelatihan ini, para petani Ketupat tidak lagi mengalami kepanikan saat pupuk subsidi langka, sekaligus secara bertahap memperbaiki ekosistem mikroba tanah pertanian agar tetap subur untuk generasi mendatang.`,
    date: '19 Okt 2023',

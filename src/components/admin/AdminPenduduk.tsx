...
export default function AdminPenduduk({ 
  ...
  return (
    <div className="max-w-7xl mx-auto pb-24 space-y-4">
      {/* Page Header */}
      <div className="sticky top-16 z-40 bg-slate-50 pb-6 -mx-4 -mt-4 px-4 pt-4 md:-mx-6 md:-mt-6 md:px-6 md:pt-6 lg:-mx-8 lg:-mt-8 lg:px-8 lg:pt-8 border-b border-slate-200 flex flex-col md:flex-row md:items-end justify-between gap-4 mb-6">
        <div>
          <nav className="flex text-xs text-gray-500 mb-2 gap-2 font-medium">
            <span>Dashboard</span>
            <span>/</span>
            <span className="text-emerald-700 font-bold">Penduduk</span>
          </nav>
          <h2 className="text-3xl font-bold text-gray-900 tracking-tight">Daftar Penduduk</h2>
          <p className="text-gray-500 mt-1 text-sm">Kelola data informasi kependudukan {villageName}.</p>
        </div>
        <div className="flex flex-wrap items-center gap-2 sm:gap-3 w-full md:w-auto">
          <button onClick={() => setShowImportModal(true)} className="flex-1 md:flex-none justify-center flex items-center gap-2 px-3 sm:px-4 py-2.5 rounded-lg border border-emerald-700 text-emerald-700 font-bold text-xs sm:text-sm hover:bg-emerald-50 transition-colors shadow-sm bg-white whitespace-nowrap">
          ...
          <div className="relative flex-1 md:flex-none">
            <button 
              ...
              className="w-full justify-center flex items-center gap-2 px-3 sm:px-4 py-2.5 rounded-lg border border-emerald-700 text-emerald-700 font-bold text-xs sm:text-sm hover:bg-emerald-50 transition-colors shadow-sm bg-white whitespace-nowrap"
            >
            ...
            {showExportMenu && (
              <>
                ...
                <div className="absolute right-0 mt-2 w-52 bg-white border border-gray-100 rounded-xl shadow-lg py-1.5 z-50 animate-in fade-in zoom-in-95 slide-in-from-bottom-4 duration-300 ease-out">
                  <button 
                    onClick={() => handleExportData('json')} 
                    className="w-full text-left px-4 py-2.5 text-xs font-semibold text-gray-700 hover:bg-emerald-50/50 flex items-center gap-2 transition-colors"
                  >
          ...
          <button onClick={() => setEditingPenduduk({})} className="flex-1 md:flex-none justify-center flex items-center gap-2 px-4 sm:px-6 py-2.5 rounded-lg bg-emerald-700 text-white font-bold text-xs sm:text-sm shadow-sm hover:bg-emerald-800 transition-colors whitespace-nowrap">
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-7 gap-3">
        <div className="bg-white p-4 rounded-2xl border border-gray-100 shadow-sm flex flex-col justify-center items-center text-center col-span-2 md:col-span-1">
        ...
        <div className="bg-white p-4 rounded-2xl border border-gray-100 shadow-sm flex flex-col justify-center items-center text-center">
            <p className="text-xs font-semibold text-gray-500 mb-1">Laki-Laki</p>
            <h3 className="text-xl font-bold text-gray-900"><NumberCounter end={maleCount} /></h3>
        </div>
        <div className="bg-white p-4 rounded-2xl border border-gray-100 shadow-sm flex flex-col justify-center items-center text-center">
            <p className="text-xs font-semibold text-gray-500 mb-1">Perempuan</p>
            <h3 className="text-xl font-bold text-gray-900"><NumberCounter end={femaleCount} /></h3>
        </div>
        <div className="bg-white p-4 rounded-2xl border border-gray-100 shadow-sm flex flex-col justify-center items-center text-center">
            <p className="text-xs font-semibold text-gray-500 mb-1">Anak (0-11)</p>
            <h3 className="text-xl font-bold text-gray-900"><NumberCounter end={childCount} /></h3>
        </div>
        <div className="bg-white p-4 rounded-2xl border border-gray-100 shadow-sm flex flex-col justify-center items-center text-center">
            <p className="text-xs font-semibold text-gray-500 mb-1">Remaja (12-17)</p>
            <h3 className="text-xl font-bold text-gray-900"><NumberCounter end={teenagerCount} /></h3>
        </div>
        <div className="bg-white p-4 rounded-2xl border border-gray-100 shadow-sm flex flex-col justify-center items-center text-center">
            <p className="text-xs font-semibold text-gray-500 mb-1">Dewasa (18-59)</p>
            <h3 className="text-xl font-bold text-gray-900"><NumberCounter end={adultCount} /></h3>
        </div>
        <div className="bg-white p-4 rounded-2xl border border-gray-100 shadow-sm flex flex-col justify-center items-center text-center">
            <p className="text-xs font-semibold text-gray-500 mb-1">Lansia (60+)</p>
            <h3 className="text-xl font-bold text-gray-900"><NumberCounter end={elderlyCount} /></h3>
        </div>
      </div>
        ...
        <div className="flex mb-6 flex-col gap-5">
          {showQuickFilters && (
            <div className="flex flex-wrap items-center gap-2 animate-in fade-in slide-in-from-top-1 duration-200">
              <span className="text-sm font-bold text-gray-600 mr-2">Filter Cepat:</span>
              {FILTERS.map((filter) => (
                <button 
                  key={filter}
          ...
          <div className="flex mb-6 flex-col md:flex-row md:items-center gap-3">
            <div className="flex-1 relative">
              ...
              <input 
                ...
                className="w-full pl-10 pr-4 py-2.5 rounded-xl border border-gray-200 focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500 text-sm text-gray-800 placeholder:text-gray-400 outline-none transition-shadow"
              />
            </div>
            <div className="flex gap-2">
              <select 
                ...
                className="px-4 py-2.5 rounded-xl border border-gray-200 focus:ring-2 focus:ring-emerald-500 text-sm font-medium text-gray-700 bg-white outline-none cursor-pointer min-w-[160px]"
              >
      ...
      <div className="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
        <div className="overflow-x-auto">
          <table className="w-full text-left border-collapse">
            <thead className="bg-gray-50/80 border-b border-gray-100">
              <tr>
                <th className="px-6 py-4 text-xs font-bold text-gray-500 uppercase tracking-wider whitespace-nowrap">NIK / No. KK</th>
                <th className="px-6 py-4 text-xs font-bold text-gray-500 uppercase tracking-wider whitespace-nowrap">Nama Lengkap / KK</th>
                <th className="px-6 py-4 text-xs font-bold text-gray-500 uppercase tracking-wider whitespace-nowrap">Status / Gender</th>
                <th className="px-6 py-4 text-xs font-bold text-gray-500 uppercase tracking-wider whitespace-nowrap">Umur</th>
                <th className="px-6 py-4 text-xs font-bold text-gray-500 uppercase tracking-wider whitespace-nowrap">RT/RW</th>
                <th className="px-6 py-4 text-xs font-bold text-gray-500 uppercase tracking-wider whitespace-nowrap hidden lg:table-cell">Bantuan Aktif</th>
                <th className="px-6 py-4 text-xs font-bold text-gray-500 uppercase tracking-wider text-center whitespace-nowrap sticky right-0 bg-gray-50 z-10 shadow-[-4px_0_8px_rgba(0,0,0,0.02)] border-l border-gray-100">Aksi</th>
              </tr>
            </thead>
        ...
        <div className="bg-gray-50/50 px-6 py-4 border-t border-gray-100 flex flex-col sm:flex-row items-center justify-between gap-4">
          <p className="text-sm text-gray-500 font-medium">
            ...
            </span> dari <span className="font-bold text-gray-900">{filteredData.length}</span> data
          </p>
          <div className="flex items-center gap-1.5">
            <button 
              onClick={() => setCurrentPage(prev => Math.max(1, prev - 1))}
              className="p-2 rounded-lg border border-gray-200 text-gray-600 bg-white hover:bg-gray-50 transition-colors disabled:opacity-50"
      ...
      {showAiAnalysis && (
        <div className="fixed inset-0 z-[100] flex items-center justify-center p-4">
          ...
          <div className="bg-white rounded-2xl w-full max-w-lg shadow-2xl relative flex flex-col max-h-[90vh] overflow-hidden animate-in fade-in zoom-in duration-300">
            <div className="p-6 border-b border-gray-100 flex items-center justify-between bg-indigo-50/50">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <h3 className="font-bold text-gray-900">Analisis Penduduk AI</h3>
                  <p className="text-xs font-medium text-gray-500">Berdasarkan data {residents.length} penduduk terdaftar</p>
                </div>
              </div>
              <button onClick={() => setShowAiAnalysis(false)} className="p-2 text-gray-400 hover:bg-gray-100 rounded-lg transition-colors">
                <FilterX size={20} />
              </button>
            </div>
            ...
            <div className="p-4 border-t border-gray-100 bg-white flex justify-end">
              <button onClick={() => setShowAiAnalysis(false)} className="px-4 py-2 bg-gray-100 hover:bg-gray-200 text-gray-700 font-bold text-sm rounded-lg transition-colors">
                Tutup Analisis
              </button>
            </div>
          </div>
    ...
    <motion.tr data-nik={nik} initial={{ opacity: 0, scale: 0.95 }} animate={{ opacity: 1, scale: 1 }} exit={{ opacity: 0, scale: 0.9, height: 0, transition: { duration: 0.3 } }} className="hover:bg-gray-50/80 transition-colors group cursor-pointer">
      <td className="px-6 py-3.5 whitespace-nowrap">
        <div className="flex flex-col">
          <span className="text-sm font-semibold text-gray-900 font-mono group-hover:text-emerald-700 transition-colors">{nik}</span>
        ...
        <div className="flex flex-col">
          <div className="flex items-center gap-2">
            ...
            {status === 'pending_approval' && (
              <span className="bg-amber-100 text-amber-800 text-[9px] font-black px-2 py-0.5 rounded-full border border-amber-200 shadow-sm shrink-0 uppercase tracking-wider">
                Menunggu Konfirmasi
              </span>
            )}
          </div>
      ...
      <td className="px-6 py-3.5 whitespace-nowrap">
        <div className="flex flex-col gap-1.5 items-start">
          <span className="text-[11px] font-bold text-gray-600 bg-gray-100 px-2 py-1 rounded-md border border-gray-200 leading-none">{status === 'pending_approval' ? 'Pending' : (status || '-')}</span>
          <span className={`text-[10px] px-2 py-1 rounded-md font-bold border whitespace-nowrap leading-none ${getBadgeColors(genderColor)}`}>
            {gender}
          </span>
        </div>
      </td>
      <td className="px-6 py-3.5 text-sm font-medium text-gray-600 whitespace-nowrap">
        {age} Thn
      </td>
      <td className="px-6 py-3.5 text-sm font-medium text-gray-600 whitespace-nowrap">{rtRw}</td>
      <td className="px-6 py-3.5 whitespace-nowrap hidden lg:table-cell">
        {activeAids && activeAids.length > 0 ? (
          <span className="inline-flex items-center gap-1.5 px-2.5 py-1 rounded-full font-bold text-xs bg-emerald-50 text-emerald-700 border border-emerald-100 shadow-sm whitespace-nowrap" title={activeAids.join(', ')}>
      ...
      <td className="px-6 py-3.5 whitespace-nowrap sticky right-0 bg-white z-10 border-l border-gray-50 shadow-[-4px_0_8px_rgba(0,0,0,0.02)] group-hover:bg-gray-50 transition-colors">

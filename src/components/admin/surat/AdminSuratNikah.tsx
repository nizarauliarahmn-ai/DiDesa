  ...
  const getDocHtml = (docId?: string) => {
    ...
    if (targetDoc.startsWith('biodata')) {
      ...
      html = `
        ...
        <p style="margin:0 0 60px;text-align:justify;">Demikian surat pernyataan ini dibuat dengan sebenarnya dalam keadaan sadar, tanpa ada unsur paksa dari pihak mana pun, dan untuk dipergunakan sebagaimana mestinya.</p>
        ...
        <div style="margin-top:24px;">
          ...
          <table style="width:100%;border-collapse:collapse;font-family:${letterFont};margin:0;border:1px solid #000;">
            <tr>
              ...
              <td style="width:35%;padding:6px 8px;font-weight:bold;border:1px solid #000;background:#f0f0f0;">Nama</td>
              <td style="width:20%;padding:6px 8px;font-weight:bold;border:1px solid #000;background:#f0f0f0;">Sebagai</td>
              <td style="width:40%;padding:6px 8px;font-weight:bold;border:1px solid #000;background:#f0f0f0;text-align:center;">Tanda Tangan</td>
            </tr>
            <tr>
              <td style="width:5%;padding:8px;border:1px solid #000;vertical-align:top;">1.</td>
              <td style="width:35%;padding:8px;border:1px solid #000;vertical-align:top;">${formData.saksi1Nama ? vn(formData.saksi1Nama) : '........................................'}</td>
              <td style="width:20%;padding:8px;border:1px solid #000;vertical-align:top;">${formData.saksi1Sebagai ? v(formData.saksi1Sebagai) : '........................................'}</td>
              <td style="width:40%;padding:8px;border:1px solid #000;vertical-align:top;"><span style="display:inline-block;padding-left:20px;font-size:9px;color:#666;">1</span><br/><span style="display:inline-block;padding-left:20px;border-bottom:1px dotted #000;width:80%;">...................................................................</span></td>
            </tr>
            <tr>
              ...
              <td style="width:20%;padding:8px;border:1px solid #000;vertical-align:top;">${formData.saksi2Sebagai ? v(formData.saksi2Sebagai) : '........................................'}</td>
              <td style="width:40%;padding:8px;border:1px solid #000;vertical-align:top;"><span style="display:inline-block;padding-left:80px;font-size:9px;color:#666;">2</span><br/><span style="display:inline-block;padding-left:80px;border-bottom:1px dotted #000;width:60%;">...................................................................</span></td>
            </tr>
            <tr>
              <td style="width:5%;padding:8px;border:1px solid #000;vertical-align:top;">3.</td>
              <td style="width:35%;padding:8px;border:1px solid #000;vertical-align:top;">${formData.saksi3Nama ? vn(formData.saksi3Nama) : '........................................'}</td>
              <td style="width:20%;padding:8px;border:1px solid #000;vertical-align:top;">${formData.saksi3Sebagai ? v(formData.saksi3Sebagai) : '........................................'}</td>
              <td style="width:40%;padding:8px;border:1px solid #000;vertical-align:top;"><span style="display:inline-block;padding-left:20px;font-size:9px;color:#666;">3</span><br/><span style="display:inline-block;padding-left:20px;border-bottom:1px dotted #000;width:80%;">...................................................................</span></td>
            </tr>
          </table>
        </div>
      `;

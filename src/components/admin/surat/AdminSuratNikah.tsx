  ...
  const getDocHtml = (docId?: string) => {
    ...
    if (targetDoc.startsWith('biodata')) {
      ...
      html = `
        ...
        <p style="margin:12px 0;text-align:justify;">Menyatakan dengan sebenarnya bahwa Saya belum pernah MENIKAH/KAWIN. Surat keterangan ini dibuat untuk "memenuhi kelengkapan berkas pernikahan".</p>

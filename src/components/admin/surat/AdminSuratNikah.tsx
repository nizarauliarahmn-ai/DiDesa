        ...
        <div style="margin-top:24px;">
          ...
          <table style="width:100%;border-collapse:collapse;font-family:${letterFont};margin:0;border:1px solid #000;">
            <tr>
              ...
              <td style="width:45%;padding:6px 8px;font-weight:bold;border:1px solid #000;background:#f0f0f0;text-align:center;">Nama</td>
            ...
            <tr>
              ...
              <td style="width:25%;padding:8px;border:1px solid #000;vertical-align:bottom;"><span style="font-size:8px;color:#999;">1</span> <span style="display:inline-block;border-bottom:1px dotted #000;width:70%;">...</span></td>
            </tr>
            <tr>
              ...
              <td style="width:25%;padding:8px;border:1px solid #000;vertical-align:bottom;"><span style="font-size:8px;color:#999;">2</span> <span style="display:inline-block;border-bottom:1px dotted #000;width:70%;">...</span></td>
            </tr>
            <tr>
              ...
              <td style="width:25%;padding:8px;border:1px solid #000;vertical-align:bottom;"><span style="font-size:8px;color:#999;">3</span> <span style="display:inline-block;border-bottom:1px dotted #000;width:70%;">...</span></td>
            </tr>
          </table>
        </div>
      `;

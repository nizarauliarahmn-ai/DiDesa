        ...
        <div style="margin-top:24px;">
          ...
          <table style="width:100%;border-collapse:collapse;font-family:${letterFont};margin:0;border:1px solid #000;">
            ...
            <tr>
              ...
              <td style="width:35%;padding:8px;border:1px solid #000;vertical-align:top;">1 ...............</td>
            </tr>
            <tr>
            ...
            <tr>
              ...
              <td style="width:35%;padding:8px;border:1px solid #000;vertical-align:top;">3 ...............</td>
            </tr>
          </table>
        </div>
      `;
        ...
        {step === 6 && (
          <div className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-700 rounded-xl p-6 shadow-sm dark:shadow-none print:hidden">
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
              ...
              {/* KIRI: KONTROL & TABS */}
              <div className="lg:col-span-5 flex flex-col gap-6" onKeyDownCapture={e => { if (e.key === 'Enter' && !(e.target as HTMLElement)?.closest('[data-suggest]')) { e.preventDefault(); e.stopPropagation(); } }}>

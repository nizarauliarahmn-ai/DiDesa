...
export default function AdminSuratSKAW({ 
  ...
  }, [formData, previewIframeReady, familyMembers, selectedFamilyMembers, heirRows]);
      ...
      <div className="w-full grid grid-cols-1 lg:grid-cols-12 gap-6 mt-6">
        ...
        <div className="lg:col-span-5 space-y-6">
          <div className="sticky top-[220px] space-y-6">
            <div className="bg-white/50 dark:bg-slate-900/50 backdrop-blur-sm rounded-2xl overflow-hidden shadow-md flex flex-col sticky top-[220px]">

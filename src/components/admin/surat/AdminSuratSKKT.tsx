          ...
          <div className="bg-white dark:bg-slate-900 p-6 rounded-2xl border border-gray-100 dark:border-slate-800 shadow-sm space-y-4">
            ...
            <div className="grid grid-cols-2 gap-3 text-xs">
              ...
              <div>
                ...
                <input type="text" inputMode="numeric" pattern="[0-9]*" placeholder="6303..." value={formData.nik} onChange={e => setFormData({ ...formData, nik: e.target.value.replace(/[^0-9]/g, '') })} className="w-full px-4 py-3 bg-slate-50 dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-xl outline-none font-mono" />
              </div>
              <div>
              ...
              <div>
                ...
                <input type="date" value={formData.tanggalLahir} onChange={e => setFormData({ ...formData, tanggalLahir: e.target.value })} className="w-full px-4 py-3 bg-slate-50 dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-xl outline-none" />
              </div>
              <div>
              ...
              <div>
                ...
                <input type="text" placeholder="cth: Jl. Keramat, Desa Wasah Hilir" value={formData.alamat} onChange={e => setFormData({ ...formData, alamat: e.target.value })} className="w-full px-4 py-3 bg-slate-50 dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-xl outline-none" />
              </div>
            </div>
          </div>
          ...
          <div className="bg-white dark:bg-slate-900 p-6 rounded-2xl border border-gray-100 dark:border-slate-800 shadow-sm space-y-4">
            ...
            <div className="space-y-3 pt-2">
              ...
              <div>
                ...
                {luasSatuan === 'm2' && (
                  <div className="relative flex items-center rounded-xl transition-all bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700">
                    <input type="text" inputMode="decimal" placeholder="cth: 42" value={formData.luasTanah} onChange={e => setFormData({ ...formData, luasTanah: e.target.value.replace(/[^0-9.]/g, '') })} className="flex-1 px-4 py-3 rounded-l-xl outline-none font-mono text-[11px] bg-transparent text-gray-900 dark:text-white" />
                    <select value={luasSatuan} onChange={e => { setLuasSatuan(e.target.value as any); setCalcBorongan(''); setCalcPanjang(''); setCalcLebar(''); }} className="px-2 py-3 pr-3 text-[10px] font-bold rounded-r-xl border-l border-slate-200 dark:border-slate-600 outline-none bg-amber-50 text-amber-700 cursor-pointer">
                ...
                {luasSatuan === 'meter' && (
                  <div className="space-y-1.5">
                    <div className="flex gap-2 items-center">
                      <div className="relative flex-1 flex items-center rounded-xl transition-all bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700">
                        <input type="text" inputMode="decimal" placeholder="Panjang (m)" value={calcPanjang} onChange={e => { const v = e.target.value.replace(/[^0-9.]/g, ''); setCalcPanjang(v); if (v && calcLebar && parseFloat(v) > 0 && parseFloat(calcLebar) > 0) setFormData(prev => ({ ...prev, luasTanah: (parseFloat(v) * parseFloat(calcLebar)).toFixed(2) })); }} className="flex-1 px-3 py-2.5 rounded-l-xl outline-none font-mono text-[11px] bg-transparent text-gray-900 dark:text-white" />
                        <span className="absolute right-2 text-[10px] text-gray-400 font-bold pointer-events-none">m</span>
                      </div>
                      <span className="text-gray-400 font-bold text-xs">×</span>
                      <div className="relative flex-1 flex items-center rounded-xl transition-all bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700">
                        <input type="text" inputMode="decimal" placeholder="Lebar (m)" value={calcLebar} onChange={e => { const v = e.target.value.replace(/[^0-9.]/g, ''); setCalcLebar(v); if (calcPanjang && v && parseFloat(calcPanjang) > 0 && parseFloat(v) > 0) setFormData(prev => ({ ...prev, luasTanah: (parseFloat(calcPanjang) * parseFloat(v)).toFixed(2) })); }} className="flex-1 px-3 py-2.5 rounded-l-xl outline-none font-mono text-[11px] bg-transparent text-gray-900 dark:text-white" />
                        <span className="absolute right-2 text-[10px] text-gray-400 font-bold pointer-events-none">m</span>
                      </div>
                      <select value={luasSatuan} onChange={e => { setLuasSatuan(e.target.value as any); setCalcBorongan(''); setCalcPanjang(''); setCalcLebar(''); }} className="px-2 py-2.5 pr-3 text-[10px] font-bold rounded-xl border-l border-slate-200 dark:border-slate-600 outline-none bg-amber-50 text-amber-700 cursor-pointer">
                        <option value="m2">m²</option>
                        <option value="borongan">Borong</option>
                        <option value="meter">Meter</option>
                      </select>
              ...
              <div className="grid grid-cols-2 gap-3 text-xs">
                <div>
                  ...
                  <input type="text" placeholder="Nama Pemilik Batas" value={formData.batasUtara} onChange={e => setFormData({ ...formData, batasUtara: e.target.value })} className="w-full px-4 py-3 rounded-xl outline-none mb-1 transition-all bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 text-gray-900 dark:text-white" />
                  <div className="relative">
                    <input type="text" inputMode="decimal" placeholder="cth: 6" value={formData.ukuranUtara} onChange={e => setFormData({ ...formData, ukuranUtara: e.target.value.replace(/[^0-9.]/g, '') })} className="w-full px-4 py-3 pr-14 rounded-xl outline-none font-mono text-[11px] transition-all bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 text-gray-900 dark:text-white" />
                ...
                <div>
                  ...
                  <input type="text" placeholder="Nama Pemilik Batas" value={formData.batasSelatan} onChange={e => setFormData({ ...formData, batasSelatan: e.target.value })} className="w-full px-4 py-3 rounded-xl outline-none mb-1 transition-all bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 text-gray-900 dark:text-white" />
                  <div className="relative">
                    <input type="text" inputMode="decimal" placeholder="cth: 6.5" value={formData.ukuranSelatan} onChange={e => setFormData({ ...formData, ukuranSelatan: e.target.value.replace(/[^0-9.]/g, '') })} className="w-full px-4 py-3 pr-14 rounded-xl outline-none font-mono text-[11px] transition-all bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 text-gray-900 dark:text-white" />
                    <span className="absolute right-3 top-1/2 -translate-y-1/2 text-[11px] text-gray-400 font-medium pointer-events-none">meter</span>
                  </div>
                </div>
                <div>
                  <span className="text-gray-500 block text-[10px]">Timur (Pemilik / Ukuran)</span>
                  <input type="text" placeholder="Nama Pemilik Batas" value={formData.batasTimur} onChange={e => setFormData({ ...formData, batasTimur: e.target.value })} className="w-full px-4 py-3 rounded-xl outline-none mb-1 transition-all bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 text-gray-900 dark:text-white" />
                  <div className="relative">
                    <input type="text" inputMode="decimal" placeholder="cth: 7" value={formData.ukuranTimur} onChange={e => setFormData({ ...formData, ukuranTimur: e.target.value.replace(/[^0-9.]/g, '') })} className="w-full px-4 py-3 pr-14 rounded-xl outline-none font-mono text-[11px] transition-all bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 text-gray-900 dark:text-white" />
                    <span className="absolute right-3 top-1/2 -translate-y-1/2 text-[11px] text-gray-400 font-medium pointer-events-none">meter</span>
                  </div>
                </div>
                <div>
                  <span className="text-gray-500 block text-[10px]">Barat (Pemilik / Ukuran)</span>
                  <input type="text" placeholder="Nama Pemilik Batas" value={formData.batasBarat} onChange={e => setFormData({ ...formData, batasBarat: e.target.value })} className="w-full px-4 py-3 rounded-xl outline-none mb-1 transition-all bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 text-gray-900 dark:text-white" />
                  <div className="relative">
                    <input type="text" inputMode="decimal" placeholder="cth: 7" value={formData.ukuranBarat} onChange={e => setFormData({ ...formData, ukuranBarat: e.target.value.replace(/[^0-9.]/g, '') })} className="w-full px-4 py-3 pr-14 rounded-xl outline-none font-mono text-[11px] transition-all bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 text-gray-900 dark:text-white" />
                    <span className="absolute right-3 top-1/2 -translate-y-1/2 text-[11px] text-gray-400 font-medium pointer-events-none">meter</span>
                  </div>
                </div>
              </div>
          ...
          <div className="bg-white dark:bg-slate-900 p-6 rounded-2xl border border-gray-100 dark:border-slate-800 shadow-sm space-y-4">
            ...
            <div className="p-3 bg-gray-50 dark:bg-slate-800/50 rounded-xl border border-gray-100 dark:border-slate-700 space-y-2 text-xs">
              ...
              <div className="grid grid-cols-2 gap-2">
                <input type="text" placeholder="Nama Lengkap Saksi 1" value={formData.saksi1Nama} onChange={e => setFormData({ ...formData, saksi1Nama: e.target.value })} className="px-4 py-3 bg-slate-50 dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-xl outline-none" />
                <input type="text" inputMode="numeric" pattern="[0-9]*" placeholder="6303..." value={formData.saksi1Nik} onChange={e => setFormData({ ...formData, saksi1Nik: e.target.value.replace(/[^0-9]/g, '') })} className="px-4 py-3 bg-slate-50 dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-xl outline-none font-mono" />
              </div>
            </div>
            ...
            <div className="p-3 bg-gray-50 dark:bg-slate-800/50 rounded-xl border border-gray-100 dark:border-slate-700 space-y-2 text-xs">
              ...
              <div className="grid grid-cols-2 gap-2">
                <input type="text" placeholder="Nama Lengkap Saksi 2" value={formData.saksi2Nama} onChange={e => setFormData({ ...formData, saksi2Nama: e.target.value })} className="px-4 py-3 bg-slate-50 dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-xl outline-none" />
                <input type="text" inputMode="numeric" pattern="[0-9]*" placeholder="6303..." value={formData.saksi2Nik} onChange={e => setFormData({ ...formData, saksi2Nik: e.target.value.replace(/[^0-9]/g, '') })} className="px-4 py-3 bg-slate-50 dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-xl outline-none font-mono" />
              </div>
            </div>
            ...
            <div className="p-3 bg-gray-50 dark:bg-slate-800/50 rounded-xl border border-gray-100 dark:border-slate-700 space-y-2 text-xs">
              ...
              <div className="grid grid-cols-2 gap-2">
                <input type="text" placeholder="Nama Lengkap Saksi 3" value={formData.saksi3Nama} onChange={e => setFormData({ ...formData, saksi3Nama: e.target.value })} className="px-4 py-3 bg-slate-50 dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-xl outline-none" />
                <input type="text" inputMode="numeric" pattern="[0-9]*" placeholder="6303..." value={formData.saksi3Nik} onChange={e => setFormData({ ...formData, saksi3Nik: e.target.value.replace(/[^0-9]/g, '') })} className="px-4 py-3 bg-slate-50 dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-xl outline-none font-mono" />
              </div>
            </div>
          </div>

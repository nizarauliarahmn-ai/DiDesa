...
const handlePrint = async (skipCheck = false) => {
  ...
  return (
    <div className="space-y-6 pb-20">
      ...
      <SuratEditorHeader template={getLetterHeaderTemplate('SKBM', { kode: '400', jenis: 'Surat Keterangan Belum Menikah', deskripsi: 'Surat Keterangan Belum Pernah Menikah (SKBM)', nomorSurat: formData.nomorSurat })}

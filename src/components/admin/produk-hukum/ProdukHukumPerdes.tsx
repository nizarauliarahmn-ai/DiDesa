            ...
            <table className="min-w-full text-sm">
              <thead>
                <tr className="border-b-2 border-gray-200 dark:border-slate-700">
                  ...
                  <th className="text-left px-4 py-3 font-bold text-gray-500 dark:text-slate-400 text-xs uppercase tracking-wider bg-gray-50 dark:bg-slate-800 sticky top-16 z-20">Tgl Diundangkan</th>

...
if ($content -match [System.Text.RegularExpressions.Regex]::Escape($old)) {
    ...
    Set-Content 'C:\Users\ASUS\.gemini\antigravity\scratch\DiDesa\src\components\admin\surat\AdminSuratSKU.tsx' -Value $content -Encoding UTF8
    Write-Host 'SUCCESS: SKU updated'
} else {
    Write-Host 'NOT FOUND - SKU'
}
...
# Find the exact content to replace
idx1 = content.find('grid grid-cols-2 gap-4')
idx2 = content.find('grid grid-cols-1 md:grid-cols-3 gap-4')
end = content.find('            </div>', content.find('grid grid-cols-1 md:grid-cols-3 gap-4')) + 16

old_content = content[content.find('grid grid-cols-2 gap-4'):end]

new_content = content[:content.find('grid grid-cols-2 gap-4')] + '''            </div>
            ...
            </div>''' + content[content.find('            </div>', content.find('grid grid-cols-1 md:grid-cols-3 gap-4')) + 16:]
